...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?Log@@YAXH@Z DD 025030e01H
	DD	0b209230eH
	DD	05005H
xdata	ENDS
;	COMDAT xdata
...
; File C:\Users\jakeh\Documents\GitHub\CppLearning\ConsoleApplication1\ConsoleApplication1\Log.cpp
; Line 9
$LN3:
	...
	sub	rsp, 96					; 00000060H
	lea	rbp, QWORD PTR [rsp+32]
	lea	rcx, OFFSET FLAT:__ACB0D1AE_Log@cpp
	call	__CheckForDebuggerJustMyCode
; Line 10
	mov	edx, DWORD PTR number$[rbp]
